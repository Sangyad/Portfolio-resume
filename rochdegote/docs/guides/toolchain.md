...
|---|---|---|---|
| Node.js | 22.14.0+ (tested 24.20.0) | JavaScript application | `frontend/.node-version`, `frontend/package.json` |
| npm | 11.19.0+ | Local package scripts | `frontend/package.json#packageManager`, `frontend/.npmrc` |
